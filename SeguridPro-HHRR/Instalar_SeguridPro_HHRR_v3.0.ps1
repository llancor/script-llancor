...
function Update-App {
    Write-Title
    Write-Host 'Actualizar GuardiaPro' -ForegroundColor Cyan
    Write-Host
    ...
    if(-not (Project-Ready)){
        ...
        if(Test-Path (Join-Path $installed 'docker-compose.yml')){$script:AppDir=$installed}else{Write-Host "No se encontró GuardiaPro en $installed." -ForegroundColor Red;return}
    }
