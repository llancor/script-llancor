...
const protectedModules=[['turnos','Turnos'],['relevos','Relevos'],['rondas','Rondas'],['entradas','Entradas'],['reportes','Reportes'],['alertas','Alertas']] as const;
