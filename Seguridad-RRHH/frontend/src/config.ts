...
const recinto:Field={name:'recinto_nombre',label:'Recinto',type:'select',required:true,options:[]};

export const modules:Record<string,Module>={
  guardias:{key:'guardia',title:'Guardias',singular:'guardia',subtitle:'Personal de seguridad y asignaciones',primary:'nombre',secondary:'documento',status:'estado',fields:[
    {name:'nombre',label:'Nombre completo',required:true},{name:'documento',label:'Documento',required:true},{name:'telefono',label:'Teléfono'},{name:'email',label:'Email',type:'email'},
    {name:'rango',label:'Rango',type:'select',options:['supervisor','guardia_senior','guardia','cabo','conserje','nochero']},estado(['Activo','Inactivo','Licencia','Suspendido']),
    {name:'fecha_ingreso',label:'Fecha de ingreso',type:'date'},{name:'foto_url',label:'URL de fotografía'},recinto
  ]},
  recintos:{key:'recinto',title:'Recintos',singular:'recinto',subtitle:'Instalaciones y edificios vigilados',primary:'nombre',secondary:'direccion',status:'estado',fields:[
    {name:'nombre',label:'Nombre',required:true},{name:'direccion',label:'Dirección',required:true},{name:'tipo',label:'Tipo',type:'select',options:['Condominio','Departamento','Edificio','Complejo','Urbanización','Oficina','Otro']},
    {name:'encargado',label:'Encargado'},{name:'email',label:'Email',type:'email'},{name:'telefono',label:'Teléfono'},{name:'observaciones',label:'Observaciones',type:'textarea'},estado(['Activo','Inactivo'])
  ]},
  ...
  rondas:{key:'ronda',title:'Rondas',singular:'ronda',subtitle:'Patrullas, trazado GPS y novedades',primary:'guardia_nombre',secondary:'puntos_recorridos',status:'estado',fields:[
    guardia,{name:'fecha_hora_inicio',label:'Inicio',type:'datetime-local',required:true},{name:'fecha_hora_fin',label:'Fin',type:'datetime-local'},
    {name:'puntos_recorridos',label:'Puntos recorridos',type:'textarea'},{name:'novedades',label:'Novedades',type:'textarea'},estado(['Programada','En_curso','Completada','Incidente']),
    {name:'distancia_m',label:'Distancia (m)',type:'number'},recinto
  ]}
};
