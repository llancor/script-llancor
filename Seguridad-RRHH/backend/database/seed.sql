...
VALUES ('usr_admin_demo','Administrador Seguridad','admin@seguridad.cl','$2b$12$xCaxBD99uKB249dXuIsb0u9APtSBV2u8og7QWWiQN.Yea.D6lw16u','admin','supervisor',JSON_OBJECT('guardias',true,'turnos',true,'relevos',true,'rondas',true,'recintos',true,'entradas',true,'reportes',true,'alertas',true,'usuarios',true,'configuracion',true),true)
