...
ALTER TABLE configuracion
  ...
  ADD COLUMN brand_name VARCHAR(100) NOT NULL DEFAULT 'BastControl',
  ADD COLUMN brand_subtitle VARCHAR(150) NOT NULL DEFAULT 'Centro de operaciones',
  ADD COLUMN hero_title VARCHAR(255) NOT NULL DEFAULT 'BastControl conectado, decisiones claras.',
  ...
  ADD COLUMN company_title VARCHAR(255) NOT NULL DEFAULT 'BastControl inspira confianza',
