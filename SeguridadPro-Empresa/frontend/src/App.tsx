...
const Login=lazy(()=>import('./pages/Login')),Dashboard=lazy(()=>import('./pages/Dashboard')),CrudPage=lazy(()=>import('./pages/CrudPage')),Rondas=lazy(()=>import('./pages/Rondas')),Turnos=lazy(()=>import('./pages/Turnos')),Relevos=lazy(()=>import('./pages/Relevos')),Users=lazy(()=>import('./pages/Users')),Profile=lazy(()=>import('./pages/Profile')),Config=lazy(()=>import('./pages/Config')),PublicPage=lazy(()=>import('./pages/PublicPage')),RRHH=lazy(()=>import('./pages/RRHH')),Empresas=lazy(()=>import('./pages/Empresas'));
