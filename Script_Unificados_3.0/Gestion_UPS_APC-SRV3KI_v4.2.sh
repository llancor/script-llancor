...
crear_servicio_ups() {
    ...
    SCRIPT="/root/Gestion_UPS_APC-SRV3KI_v4.2.sh"


    if [[ ! -f "$SCRIPT" ]]
    then

        mensaje_error "No existe el script:"
        echo "$SCRIPT"
...
[Service]
Type=simple
ExecStart=/bin/bash $SCRIPT --service
...
EOF
    ...
    then
        ...
        mensaje_ok "Servicio creado correctamente."
        ...
        mensaje_error "Error creando servicio."
