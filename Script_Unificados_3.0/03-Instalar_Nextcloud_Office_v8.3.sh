...
while true; do
    ...
    echo -e "${CYAN}${BOLD}=== Restaurar y Reparar Nextcloud 24.3.4 - Instalador Nextcloud===${NC}"
    echo
...
echo
echo -e "${CYAN}=============================================================${RESET}"
echo -e "${CYAN} INSTALADOR DE NEXTCLOUD PRO v8.3 Descargar Scripts GitHub   ${RESET}"
echo -e "${CYAN}=============================================================${RESET}"
echo
