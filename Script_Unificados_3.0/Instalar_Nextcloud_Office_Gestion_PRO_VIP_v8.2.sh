...
while true; do
    ...
    echo -e "${CYAN}${BOLD}=== Restaurar y Reparar Nextcloud 24.3.2 - Instalador Nextcloud===${NC}"
    echo
...
echo
echo -e "${CYAN}=============================================================${RESET}"
echo -e "${CYAN} INSTALADOR DE NEXTCLOUD PRO v8.2 Descargar Scripts GitHub   ${RESET}"
echo -e "${CYAN}=============================================================${RESET}"
echo
