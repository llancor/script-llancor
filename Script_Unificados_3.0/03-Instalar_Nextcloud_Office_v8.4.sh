...
while true; do
    ...
    echo -e "${CYAN}${BOLD}=== Restaurar y Reparar Nextcloud 24.3.5 - Instalador Nextcloud===${NC}"
    echo
    ...
    echo -e " ${YELLOW}15)${NC} ${RED}Limpiar almacenamiento Nextcloud ${CYAN}(Papelera/Versiones/Uploads)"
	echo -e " ${YELLOW}16)${NC} ${GREEN}Configurar MEMORIA PHP CLI - NEXTCLOUD${CYAN} / Actualizacion 1024mb / 2048mb"
...
echo
echo -e "${CYAN}=============================================================${RESET}"
echo -e "${CYAN} INSTALADOR DE NEXTCLOUD PRO v8.4 Descargar Scripts GitHub   ${RESET}"
echo -e "${CYAN}=============================================================${RESET}"
echo
...
echo -e "${YELLOW}*"
echo -e "${YELLOW}4)${RESET}  ${CYAN}Menu${RESET} ${CYAN}Mantenimiento Reparar/Restaurar/Configurar Nextcloud OCC${RESET}"
